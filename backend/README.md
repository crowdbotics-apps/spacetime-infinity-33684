...
## Project Structure
    ...
    ├── spacetime_infinity_33684  # Django project configurations
...
1. Clone this repo and `cd spacetime_infinity_33684`
...
2. Clone this repo and `cd spacetime_infinity_33684`
